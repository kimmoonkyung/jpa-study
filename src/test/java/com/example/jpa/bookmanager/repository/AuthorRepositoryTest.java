...
class AuthorRepositoryTest {
    ...
    void manyToManyTest() {
        ...
        Author author1 = givenAuthor("노총내");
        Author author2 = givenAuthor("짐승내");
...
//        System.out.println("## authors throuch book: " + bookRepository.findAll().get(2).getAuthors());
//        System.out.println("## books throuch author: " + authorRepository.findAll().get(0).getBooks());
